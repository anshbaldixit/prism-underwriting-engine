 ...
 * embedding provider changes, because vectors from different models are not comparable.
 */
@Component
public class PgVectorTransactionCategorizer implements TransactionCategorizer, ApplicationRunner {
    ...
    public PgVectorTransactionCategorizer(JdbcClient jdbc, EmbeddingClient embeddings) {
        this.jdbc = jdbc;
